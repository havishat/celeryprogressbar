...
#TEMPLATE_DIRS = [os.path.join(os.path.dirname(os.path.abspath(__file__)), 'sampleapp/templates')]

SETTINGS_PATH = os.path.dirname(__file__)
PROJECT_PATH = os.path.join(SETTINGS_PATH, os.pardir)
BASE_DIR = os.path.join(SETTINGS_PATH, os.pardir)
TEMPLATES_PATH = os.path.join(BASE_DIR, "sampleapp/templates")
